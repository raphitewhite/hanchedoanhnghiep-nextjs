...
export default function Sidebar({ isOpen, currentPage, onPageChange, onClose, onNavClick }: SidebarProps) {
  const navItems = [
    { id: "home", label: "Privacy Center home", icon: "home" },
    { id: "search", label: "Search", icon: "search" },
    { id: "settings", label: "Common privacy settings", icon: "settings" },
    { id: "topics", label: "Privacy topics", icon: "topics" },
    { id: "resources", label: "More privacy resources", icon: "resources" },
    { id: "policy", label: "Privacy Policy", icon: "policy", hasArrow: true },
    { id: "articles", label: "Other policies and articles", icon: "articles", hasArrow: true },
  ];
      ...
      <div className={`sidebar ${isOpen ? "active" : ""}`} id="sidebar">
        <div className="logo">
          <div className="logo-icon">
            <svg aria-label="Meta logo" role="img" viewBox="0 0 500 100" width="110" height="24">
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="_r_g_" x1="124.38" x2="160.839" y1="99" y2="59.326">
                  <stop offset=".427" stopColor="#0278F1"></stop>
                  <stop offset=".917" stopColor="#0180FA"></stop>
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="_r_h_" x1="42" x2="-1.666" y1="4.936" y2="61.707">
                  <stop offset=".427" stopColor="#0165E0"></stop>
                  <stop offset=".917" stopColor="#0180FA"></stop>
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="_r_i_" x1="27.677" x2="132.943" y1="28.71" y2="71.118">
              ...
              <path d="M145.631 36h-16.759c3.045 7.956 4.861 17.797 4.861 28.725 0 11.403-4.729 17.547-11.651 17.547H122v16.726l.449.002c16.448 0 27.617-13.723 27.617-33.25 0-10.85-1.6-20.917-4.435-29.75Z" fill="url(#_r_g_)"></path>
              <path d="M42 .016C18.63.776.832 28.908.028 63h16.92C17.483 39.716 28.762 18.315 42 17.31V.017Z" fill="url(#_r_h_)"></path>
        ...
        <div className="sidebar-title">Privacy Center</div>
        {navItems.map((item) => (
          <a
            key={item.id}
            href="#"
...
function getIcon(iconName: string) {
  const icons: Record<string, JSX.Element> = {
    ...
    resources: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" aria-hidden="true">
        <path fillRule="evenodd" clipRule="evenodd" d="M6.624 4.176 5.368 8.57l-.314-.055a11.057 11.057 0 0 1-1.331-.313 3.653 3.653 0 0 1-.29-.104 1 1 0 0 0-.88 1.795l.025.013-.024-.012h.001l.003.002.006.003.014.007a1.93 1.93 0 0 0 .15.064c.093.037.222.085.393.139.341.108.851.242 1.575.374C6.143 10.747 8.454 11 12 11c3.546 0 5.857-.253 7.304-.516a13.008 13.008 0 0 0 1.575-.374 4.777 4.777 0 0 0 .543-.203l.014-.007.006-.003.003-.001.001-.001-.062.029.063-.03a1 1 0 0 0-.88-1.795 3.664 3.664 0 0 1-.29.104c-.252.08-.68.195-1.33.313l-.315.055-1.256-4.395A3 3 0 0 0 14.491 2H9.51a3 3 0 0 0-2.885 2.176zM9.509 4a1 1 0 0 0-.962.725l-1.17 4.093C8.578 8.925 10.097 9 12 9c1.904 0 3.424-.075 4.622-.182l-1.17-4.093a1 1 0 0 0-.96-.725H9.508zM10.874 18A4.002 4.002 0 0 1 3 17a4 4 0 0 1 7.874-1h2.252A4.002 4.002 0 0 1 21 17a4 4 0 0 1-7.874 1h-2.252zM9 17.03a2 2 0 1 1 0-.06v.06zM17 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path>
      </svg>
    ),
    policy: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" aria-hidden="true">
        <path d="M12 12a2 2 0 0 1 1 3.732V17a1 1 0 1 1-2 0v-1.268A2 2 0 0 1 12 12z"></path>
        <path fillRule="evenodd" clipRule="evenodd" d="M7 6a5 5 0 0 1 10 0v2h.857c1.282 0 2.417.818 2.664 2.076A25.71 25.71 0 0 1 21 15a25.71 25.71 0 0 1-.479 4.924C20.274 21.182 19.14 22 17.857 22H6.143c-1.282 0-2.417-.818-2.664-2.076A25.711 25.711 0 0 1 3 15c0-1.984.236-3.692.479-4.924C3.726 8.818 4.86 8 6.143 8H7V6zm8 0v2H9V6a3 3 0 1 1 6 0zm-8.857 4h11.714a.84.84 0 0 1 .508.157c.107.082.17.182.194.305.223 1.133.441 2.71.441 4.538 0 1.828-.218 3.405-.441 4.538a.488.488 0 0 1-.194.305.84.84 0 0 1-.508.157H6.143a.84.84 0 0 1-.508-.157.489.489 0 0 1-.194-.305A23.712 23.712 0 0 1 5 15c0-1.828.218-3.405.441-4.538a.489.489 0 0 1 .194-.305.84.84 0 0 1 .508-.157z"></path>
      </svg>
    ),
    articles: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" aria-hidden="true">
        <path fillRule="evenodd" clipRule="evenodd" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18zm0 2c6.075 0 11-4.925 11-11S18.075 1 12 1 1 5.925 1 12s4.925 11 11 11zm0-13.702c.483 0 .875.391.875.875V17a.875.875 0 0 1-1.75 0v-6.827c0-.484.392-.875.875-.875zm0-1.275c.833 0 1.25-.405 1.25-1.012C13.25 6.405 12.833 6 12 6s-1.25.405-1.25 1.011c0 .607.417 1.012 1.25 1.012z"></path>
      </svg>
    ),
  };
